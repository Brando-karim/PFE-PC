<footer class="footer">
    ...
    <div class="section footer-top">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">
            <img src="/img/Logo.png" width="150" height="73" loading="lazy" alt="Unigine logo">
          </a>
          ...
          <ul class="social-list">
            ...
            <li>
              <a href="https://www.instagram.com/cristiano?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target=_blank class="social-link">
        ...
        <div class="footer-list">
          ...
          <div class="contact-item">
            ...
            <address class="contact-link">
              153 Berchifa Plaza, Tangier, MT 09514
            </address>
          </div>
          ...
          <div class="contact-item">
            ...
            <a href="mailto:Info@gamehive.com" class="contact-link">KimmoCommerce@Gmail.com</a>
          </div>

          <div class="contact-item">
            <span class="span">Phone:</span>

            <a href="tel:+12345678910" class="contact-link">+212 789101112</a>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2025 Benjelloul Karim All Rights Reserved.
        </p>
